...
<body style="overflow-y:hidden;">
    ...
    ob_start();
        ...
        function cartListing(){
            ...
            }else{echo "Wala kang anumang order sa cart sa ngayon";}
        }
        ...
        <div class="container-fluid">
            ...
            <form  method="post" action="<?php echo $_SERVER['PHP_SELF'];?>" class="catalog">
                ...
                <div class="cart-actions">
                    <button type="submit" name="addToCart" value="addToCart" class="button-24">Idagdag sa Order</button>
    ...
    <div class="order-view">
        <div class="total-view">
                ...
                <?php
                    ...
                    if(isset($_POST['addToCart']))
                    {
                        if(!empty($_POST["selection"])){
                            ...
                            echo "mangyaring pumili ng produkto";
                        }
            ...
            <div class="total-panel">
                ...
                font-size: 150%;
                "
                >Kabuuan: ₱<?php echo sprintf("%.2f", $total);?></p>
            ...
            <div class="button-panel">
                <form  method="post" action="<?php echo $_SERVER['PHP_SELF'];?>">
                    ...
                    <form method="post" action="../ServiceTagalog.php">  
